    ...
    <AboutContainer>
      <Flex>
        <Body1 style={{ maxWidth: '560px' }}>
          I am a software engineer with a passion for design and tech. I
          specialize in front-end development and I bring value by creating
      ...
      <Flex>
        <Body2 style={{ maxWidth: '490px' }}>
          ...
          success. I am always trying my best to accomplish that. Besides work,
          I like cycling and playing table tennis.
        </Body2>
      </Flex>
    </AboutContainer>
  )
